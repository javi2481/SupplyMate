...
from app.models import ChatInterpretation, GroupSummary, ReplenishmentSlice
...
def format_explore_answer(
    ...
    lines: list[str] = []
    if interpretation.understood_labels:
    ...
    if group_summaries:
        ...
        lines.append(
            f"**{dash.stockout_risk}** productos en riesgo de quiebre · "
            f"**{len(slice_data.purchase_list)} productos** para reponer "
