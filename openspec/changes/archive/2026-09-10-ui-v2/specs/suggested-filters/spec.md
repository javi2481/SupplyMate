...
### UI presentation (ui-v2)

- Ranking and payload MUST stay unchanged
- When `compose_next_step` has a guidance primary, these filters MUST render as secondary “Otros análisis”, not as a competing first-class row
- Duplicate stockout already offered by guidance MUST be omitted at composition time (not inside `suggest_next_filters`)
