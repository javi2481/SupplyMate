...
|------|--------|-----------|
| Control de acceso a endpoints | Parcial — API abierta en MVP local | [`tests/security/test_security.py`](../tests/security/test_security.py) rate limit `/chat` |
...
| Política de dependencias | Documentada | [`docs/operations/security-deps.md`](security-deps.md) |
