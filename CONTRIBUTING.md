...
3. For slice/scope, qty formula, or eval contract changes, read [`docs/architecture.md`](docs/architecture.md) first.
...
Frozen CI metrics and golden fixtures are documented in [`docs/evaluation.md`](docs/evaluation.md). CI validates contracts and formula logic; it does **not** run live Groq evals.
