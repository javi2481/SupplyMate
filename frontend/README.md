...
Con `VITE_SUPPLYMATE_API_URL` y FastAPI arriba, el estado es **Motor listo** (catálogo real de `/data`). Si no se pueden cargar los datos, el chrome dice **Sin catálogo** y no inventa SKUs. Nunca muestra localhost ni la URL de la API.
